...
- **My Subjects:** a notebook for each subject with rich-text lesson notes, pinned lessons and file attachments. The lesson list shows only each lesson's title, not its contents. While a notebook or lesson is open, clicking **My Subjects** in the sidebar goes straight back to the list of all subjects
