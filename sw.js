const CACHE='school-planner-v11-app-icons';
const ASSETS=['./','./index.html','./login.html','./styles.css','./app.js','./login.js','./firebase-config.js','./manifest.json','./logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
